    ...
    <div className="w-full px-64 max-[1285px]:px-52 max-lg:px-4 max-sm:px-2 flex flex-col items-center mt-6 pb-8">
      ...
      >
        ...
        <div className="flex gap-3 mt-2">
          {/* <Link href="https://wa.me/916377692?text=Hello,%20I%20would%20like%20to%20chat%20with%20you!" target="_blank">
          ...
          <Link
            // href="https://twitter.com/messages/compose?recipient_id=1729905941619810304"
            target="_blank"
          >
