...
//           <Link
//             href="https://drive.google.com/file/d/1DCIa7EEXadsLsrFPqsS8Z716ToFKO91W/view?usp=sharing"
//             target="_blank"
//             underline="none"
//           >
...
//           <Link href="https://github.com/sshivanshg" target="_blank">
...
//           <div
//             className="hover:px-3 max-sm:hover:px-2 py-2.5 dark:hover:bg-[#262626] hover:bg-[#F4F4F5] rounded-full transition-all duration-300"
    ...
    <nav className="w-full py-6 flex justify-center fixed top-0 z-50">
      <div className="rounded-full w-[850px] max-lg:w-[800px] max-[400px]:w-[345px] max-[450px]:w-[400px] max-[350px]:w-[330px] max-[321px]:w-[310px] px-2 py-1 bg-white bg-opacity-10 backdrop-blur-md border dark:border-white/20 flex items-center justify-center dark:shadow-none shadow">
        <div className="flex justify-center px-2 items-center max-sm:gap-4 gap-8 max-[400px]:gap-4 max-[450px]:gap-5 transition-all">
          ...
          <Link href="/blogs" passHref>
            <Tooltip content="Blog">
              <div className="hover:px-3 max-sm:hover:px-2 py-2.5 dark:hover:bg-[#262626] hover:bg-[#F4F4F5] rounded-full transition-all duration-300">
                <RowsIcon
                  className={`w-[16px] h-[16px] max-sm:w-[13px] max-sm:h-[13px] text-black dark:text-white ${
                    pathname === "/blogs" ? "dark:!text-[#FFC83D] !text-[#cc9e2b]" : ""
                  }`}
                />
              </div>
            </Tooltip>
          ...
          <Separator orientation="vertical" className="bg-black dark:bg-gray-400" />

          {/* Resume Link */}
          <Link href="https://drive.google.com/file/d/1mR20lmobqKMhjkkXCuS1VbXqNyzpzAjv/view?usp=sharing" passHref target="_blank">
            <Tooltip content="Resume">
              <div className="hover:px-3 max-sm:hover:px-2 py-2.5 dark:hover:bg-[#262626] hover:bg-[#F4F4F5] rounded-full transition-all duration-300">
                <FileIcon className="w-[19px] h-[19px] max-sm:h-[15px] max-sm:w-[15px] text-black dark:text-white" />
              </div>
          ...
          {/* GitHub Link */}
          <Link href="https://github.com/sshivanshg" passHref target="_blank">
            <Tooltip content="Github">
              <div className="hover:px-3 max-sm:hover:px-2 py-2.5 dark:hover:bg-[#262626] hover:bg-[#F4F4F5] rounded-full transition-all duration-300">
                <GitHubLogoIcon className="w-[19px] h-[19px] max-sm:w-[15px] max-sm:h-[15px] text-black dark:text-white" />
              </div>
          ...
          {/* X (Twitter) Link */}
          <Link href="https://x.com/sshivanshg" passHref target="_blank">
            <Tooltip content="X">
              <div className="hover:px-3 max-sm:hover:px-2 py-2.5 dark:hover:bg-[#262626] hover:bg-[#F4F4F5] rounded-full transition-all duration-300">
                <FaXTwitter className="w-[17px] h-[17px] max-sm:w-[15px] max-sm:h-[15px] text-black dark:text-white" />
              </div>
          ...
          {/* LinkedIn Link */}
          <Link href="https://www.linkedin.com/in/shivansh-gupta-a0400827b/" passHref target="_blank">
            <Tooltip content="LinkedIn">
              <div className="hover:px-3 max-sm:hover:px-2 py-2.5 dark:hover:bg-[#262626] hover:bg-[#F4F4F5] rounded-full transition-all duration-300">
                <LinkedInLogoIcon className="w-[19px] h-[19px] max-sm:w-[15px] max-sm:h-[15px] text-black dark:text-white" />
              </div>
